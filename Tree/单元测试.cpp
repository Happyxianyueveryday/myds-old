...
{	
	...
	print("tree2 后序遍历 = ", tree2.postorder1());
	print("tree2 后序遍历 = ", tree2.postorder2());
	print("tree2 层次遍历 = ", tree2.levelorder()); 
	
	cout<<"--------------------------------------------"<<endl;
	
	vector<int> postorder={2,9,5,16,17,15,19,18,12};
	Tree tree3(inorder,postorder,1); // 由中序遍历和后序遍历的构造函数 
	cout<<"tree3 = "<<endl;
	print("tree3 前序遍历 = ", tree3.preorder());
	print("tree3 中序遍历 = ", tree3.inorder());  
	print("tree3 后序遍历 = ", tree3.postorder1());
	print("tree3 后序遍历 = ", tree3.postorder2());
	...
	Tree tree4(tree3);   // 拷贝构造函数 
	print("tree4 前序遍历 = ", tree4.preorder());
	print("tree4 中序遍历 = ", tree4.inorder());  
	print("tree4 后序遍历 = ", tree4.postorder1());
	print("tree4 后序遍历 = ", tree4.postorder2());
	...
	Tree tree5(inorder2, preorder2);
	tree5=tree2=tree2;
	print("tree5 前序遍历 = ", tree5.preorder());
	print("tree5 后序遍历 = ", tree5.postorder1());
	print("tree5 后序遍历 = ", tree5.postorder2());
	...
	cout<<"地址: "<<tree5.search(30)<<" 对应的值为: "<<tree5.search(30)->val<<endl;
	cout<<"从tree5中查找结点16的地址"<<endl;
	cout<<"地址: "<<tree5.search(16)<<" 对应的值为: "<<tree5.search(16)->val<<endl;
	...
	int p=16,q=19;
	cout<<"结点16和19的最近公共祖先为: "<<tree5.lca(p,q)->val<<endl;
	cout<<"结点16和19的最近公共祖先为: "<<tree5.lca(tree5.search(p),tree5.search(q))->val<<endl;
	
	p=12,q=16;
	cout<<"结点16和12的最近公共祖先为: "<<tree5.lca(p,q)->val<<endl;
	cout<<"结点16和12的最近公共祖先为: "<<tree5.lca(tree5.search(p),tree5.search(q))->val<<endl;
	...
	cout<<"tree5的最大路径和 maxpath = "<<tree5.maxpath()<<endl;
